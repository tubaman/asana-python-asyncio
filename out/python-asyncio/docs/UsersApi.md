...
> GetFavoritesForUser200Response get_favorites_for_user(user_gid, resource_type, workspace, opt_pretty=opt_pretty, limit=limit, offset=offset, opt_fields=opt_fields)
...
async with asana_asyncio.ApiClient(configuration) as api_client:
    ...
    api_instance = asana_asyncio.UsersApi(api_client)
    ...
    try:
        # Get a user's favorites
        api_response = await api_instance.get_favorites_for_user(user_gid, resource_type, workspace, opt_pretty=opt_pretty, limit=limit, offset=offset, opt_fields=opt_fields)
        print("The response of UsersApi->get_favorites_for_user:\n")
        pprint(api_response)
...
# **get_user**
> GetUser200Response get_user(user_gid, opt_pretty=opt_pretty, opt_fields=opt_fields)
...
async with asana_asyncio.ApiClient(configuration) as api_client:
    ...
    try:
        # Get a user
        api_response = await api_instance.get_user(user_gid, opt_pretty=opt_pretty, opt_fields=opt_fields)
...
# **get_users**
> ErrorResponse get_users(workspace=workspace, team=team, opt_pretty=opt_pretty, limit=limit, offset=offset, opt_fields=opt_fields)
...
async with asana_asyncio.ApiClient(configuration) as api_client:
    ...
    try:
        # Get multiple users
        api_response = await api_instance.get_users(workspace=workspace, team=team, opt_pretty=opt_pretty, limit=limit, offset=offset, opt_fields=opt_fields)
...
# **get_users_for_team**
> GetUsersForTeam200Response get_users_for_team(team_gid, opt_pretty=opt_pretty, offset=offset, opt_fields=opt_fields)
...
async with asana_asyncio.ApiClient(configuration) as api_client:
    ...
    try:
        # Get users in a team
        api_response = await api_instance.get_users_for_team(team_gid, opt_pretty=opt_pretty, offset=offset, opt_fields=opt_fields)
        print("The response of UsersApi->get_users_for_team:\n")
        pprint(api_response)
    except Exception as e:
...
> GetUsersForTeam200Response get_users_for_workspace(workspace_gid, opt_pretty=opt_pretty, offset=offset, opt_fields=opt_fields)
...
async with asana_asyncio.ApiClient(configuration) as api_client:
    ...
    try:
        # Get users in a workspace or organization
        api_response = await api_instance.get_users_for_workspace(workspace_gid, opt_pretty=opt_pretty, offset=offset, opt_fields=opt_fields)
        print("The response of UsersApi->get_users_for_workspace:\n")
        pprint(api_response)
    except Exception as e:
