...
**custom_fields** | [**List[CustomFieldCompact]**](CustomFieldCompact.md) | Array of Custom Fields. | [optional] [readonly] 
...
**completed_by** | [**ProjectResponseAllOfCompletedBy**](ProjectResponseAllOfCompletedBy.md) |  | [optional] 
