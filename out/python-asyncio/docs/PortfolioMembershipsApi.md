...
async with asana_asyncio.ApiClient(configuration) as api_client:
    ...
    opt_fields = ['[\"access_level\",\"portfolio\",\"portfolio.name\",\"user\",\"user.name\"]'] # List[str] | This endpoint returns a resource which excludes some properties by default. To include those optional properties, set this query parameter to a comma-separated list of the properties you wish to include. (optional)
...
async with asana_asyncio.ApiClient(configuration) as api_client:
    ...
    opt_fields = ['[\"access_level\",\"offset\",\"path\",\"portfolio\",\"portfolio.name\",\"uri\",\"user\",\"user.name\"]'] # List[str] | This endpoint returns a resource which excludes some properties by default. To include those optional properties, set this query parameter to a comma-separated list of the properties you wish to include. (optional)
