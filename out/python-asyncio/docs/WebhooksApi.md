...
# **delete_webhook**
> DeleteAttachment200Response delete_webhook(webhook_gid, opt_pretty=opt_pretty)
...
# **get_webhook**
> CreateWebhook201Response get_webhook(webhook_gid, opt_pretty=opt_pretty, opt_fields=opt_fields)
...
# **update_webhook**
> CreateWebhook201Response update_webhook(webhook_gid, update_webhook_request, opt_pretty=opt_pretty, opt_fields=opt_fields)
