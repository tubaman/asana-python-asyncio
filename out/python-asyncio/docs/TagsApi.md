...
# **delete_tag**
> DeleteAttachment200Response delete_tag(tag_gid, opt_pretty=opt_pretty)
...
# **update_tag**
> CreateTag201Response update_tag(tag_gid, opt_pretty=opt_pretty, opt_fields=opt_fields)
...
async with asana_asyncio.ApiClient(configuration) as api_client:
    ...
    try:
        # Update a tag
        api_response = await api_instance.update_tag(tag_gid, opt_pretty=opt_pretty, opt_fields=opt_fields)
