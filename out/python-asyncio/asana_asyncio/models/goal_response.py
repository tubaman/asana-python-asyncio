...
class GoalResponse(BaseModel):
    ...
    current_status_update: Optional[GoalResponseAllOfCurrentStatusUpdate] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "team": GoalResponseAllOfTeam.from_dict(obj.get("team")) if obj.get("team") is not None else None,
            "workspace": GoalResponseAllOfWorkspace.from_dict(obj.get("workspace")) if obj.get("workspace") is not None else None,
            "followers": [UserCompact.from_dict(_item) for _item in obj.get("followers")] if obj.get("followers") is not None else None,
            "time_period": GoalResponseAllOfTimePeriod.from_dict(obj.get("time_period")) if obj.get("time_period") is not None else None,
            "metric": GoalResponseAllOfMetric.from_dict(obj.get("metric")) if obj.get("metric") is not None else None,
            "owner": GoalResponseAllOfOwner.from_dict(obj.get("owner")) if obj.get("owner") is not None else None,
            "current_status_update": GoalResponseAllOfCurrentStatusUpdate.from_dict(obj.get("current_status_update")) if obj.get("current_status_update") is not None else None,
