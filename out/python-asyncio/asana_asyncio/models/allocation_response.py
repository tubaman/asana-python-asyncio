...
class AllocationResponse(BaseModel):
    ...
    assignee: Optional[AllocationResponseAllOfAssignee] = None
    created_by: Optional[Dict[str, Any]] = None
    parent: Optional[Dict[str, Any]] = None
    resource_subtype: Optional[StrictStr] = Field(default=None, description="The subtype of the allocation.")
    __properties: ClassVar[List[str]] = ["gid", "resource_type", "start_date", "end_date", "effort", "assignee", "created_by", "parent", "resource_subtype"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "assignee": AllocationResponseAllOfAssignee.from_dict(obj["assignee"]) if obj.get("assignee") is not None else None,
