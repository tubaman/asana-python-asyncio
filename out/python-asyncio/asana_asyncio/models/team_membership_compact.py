...
class TeamMembershipCompact(BaseModel):
    ...
    is_guest: Optional[StrictBool] = Field(default=None, description="Describes if the user is a guest in the team.")
    is_limited_access: Optional[StrictBool] = Field(default=None, description="Describes if the user has limited access to the team.")
    is_admin: Optional[StrictBool] = Field(default=None, description="Describes if the user is a team admin.")
    __properties: ClassVar[List[str]] = ["gid", "resource_type", "user", "team", "is_guest", "is_limited_access", "is_admin"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "team": TeamCompact.from_dict(obj.get("team")) if obj.get("team") is not None else None,
            "is_guest": obj.get("is_guest"),
            "is_limited_access": obj.get("is_limited_access"),
