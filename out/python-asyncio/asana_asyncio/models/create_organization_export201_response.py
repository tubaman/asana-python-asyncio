...
class CreateOrganizationExport201Response(BaseModel):
    """
    CreateOrganizationExport201Response
    """ # noqa: E501
    data: Optional[OrganizationExportCompact] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": OrganizationExportCompact.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
