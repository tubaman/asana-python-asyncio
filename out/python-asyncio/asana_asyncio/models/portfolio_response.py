...
class PortfolioResponse(BaseModel):
    ...
    custom_field_settings: Optional[List[CustomFieldSettingResponse]] = Field(default=None, description="Array of custom field settings applied to the portfolio.")
    current_status_update: Optional[PortfolioResponseAllOfCurrentStatusUpdate] = None
    ...
    __properties: ClassVar[List[str]] = ["gid", "resource_type", "name", "color", "created_at", "created_by", "custom_field_settings", "current_status_update", "due_on", "custom_fields", "members", "owner", "start_on", "workspace", "permalink_url", "public", "project_templates"]
    ...
    def color_validate_enum(cls, value):
        ...
        if value not in ('dark-pink', 'dark-green', 'dark-blue', 'dark-red', 'dark-teal', 'dark-brown', 'dark-orange', 'dark-purple', 'dark-warm-gray', 'light-pink', 'light-green', 'light-blue', 'light-red', 'light-teal', 'light-brown', 'light-orange', 'light-purple', 'light-warm-gray'):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        if self.project_templates:
            for _item in self.project_templates:
                if _item:
                    _items.append(_item.to_dict())
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "current_status_update": PortfolioResponseAllOfCurrentStatusUpdate.from_dict(obj.get("current_status_update")) if obj.get("current_status_update") is not None else None,
            ...
            "owner": UserCompact.from_dict(obj.get("owner")) if obj.get("owner") is not None else None,
            "start_on": obj.get("start_on"),
            "workspace": PortfolioResponseAllOfWorkspace.from_dict(obj.get("workspace")) if obj.get("workspace") is not None else None,
            "permalink_url": obj.get("permalink_url"),
            "public": obj.get("public"),
            "project_templates": [ProjectTemplateCompact.from_dict(_item) for _item in obj.get("project_templates")] if obj.get("project_templates") is not None else None
        })
        return _obj
