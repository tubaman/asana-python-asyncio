...
class OrganizationExportCompact(BaseModel):
    ...
    def state_validate_enum(cls, value):
        ...
        if value not in set(['pending', 'started', 'finished', 'error']):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "state": obj.get("state"),
            "organization": WorkspaceCompact.from_dict(obj["organization"]) if obj.get("organization") is not None else None
        })
        return _obj
