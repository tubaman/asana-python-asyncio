...
class CreateTimeTrackingEntry201Response(BaseModel):
    """
    CreateTimeTrackingEntry201Response
    """ # noqa: E501
    data: Optional[TimeTrackingEntryBase] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": TimeTrackingEntryBase.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
