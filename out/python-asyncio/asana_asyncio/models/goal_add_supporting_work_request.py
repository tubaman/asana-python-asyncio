...
class GoalAddSupportingWorkRequest(BaseModel):
    ...
    """ # noqa: E501
    supporting_work: StrictStr = Field(description="The project/task/portfolio gid to add as supporting work for a goal")
    __properties: ClassVar[List[str]] = ["supporting_work"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "supporting_work": obj.get("supporting_work")
        })
        return _obj
