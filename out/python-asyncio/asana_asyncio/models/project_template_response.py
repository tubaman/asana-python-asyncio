...
class ProjectTemplateResponse(BaseModel):
    ...
    team: Optional[ProjectTemplateBaseAllOfTeam] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "owner": ProjectTemplateBaseAllOfOwner.from_dict(obj.get("owner")) if obj.get("owner") is not None else None,
            "team": ProjectTemplateBaseAllOfTeam.from_dict(obj.get("team")) if obj.get("team") is not None else None,
            "requested_dates": [DateVariableCompact.from_dict(_item) for _item in obj.get("requested_dates")] if obj.get("requested_dates") is not None else None,
            "color": obj.get("color"),
            "requested_roles": [TemplateRole.from_dict(_item) for _item in obj.get("requested_roles")] if obj.get("requested_roles") is not None else None
        })
        return _obj
