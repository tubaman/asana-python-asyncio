...
class GraphExportCompact(BaseModel):
    ...
    download_url: Optional[StrictStr] = Field(default=None, description="Download this URL to retrieve the full export in JSON format. It will be compressed in a gzip (.gz) container.  *Note: May be null if the export is still in progress or failed.  If present, this URL may only be valid for 1 hour from the time of retrieval. You should avoid persisting this URL somewhere and rather refresh on demand to ensure you do not keep stale URLs.*")
    completed_at: Optional[datetime] = Field(default=None, description="The time at which this resource was completed.")
    __properties: ClassVar[List[str]] = ["gid", "resource_type", "created_at", "download_url", "completed_at"]
