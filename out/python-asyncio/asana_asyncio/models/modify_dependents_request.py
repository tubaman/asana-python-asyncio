...
class ModifyDependentsRequest(BaseModel):
    ...
    """ # noqa: E501
    dependents: Optional[List[StrictStr]] = Field(default=None, description="An array of task gids that are dependents of the given task.")
    __properties: ClassVar[List[str]] = ["dependents"]
