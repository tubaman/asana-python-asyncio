...
class WebhookResponse(BaseModel):
    ...
    delivery_retry_count: Optional[StrictInt] = Field(default=None, description="The number of times the webhook has retried delivery of events to the target (resets after a successful attempt).")
    next_attempt_after: Optional[datetime] = Field(default=None, description="The timestamp after which the webhook will next attempt to deliver an event to the target.")
    failure_deletion_timestamp: Optional[datetime] = Field(default=None, description="The timestamp when the webhook will be deleted if there is no successful attempt to deliver events to the target")
    ...
    __properties: ClassVar[List[str]] = ["gid", "resource_type", "active", "resource", "target", "created_at", "last_failure_at", "last_failure_content", "last_success_at", "delivery_retry_count", "next_attempt_after", "failure_deletion_timestamp", "filters"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "resource": AsanaNamedResource.from_dict(obj["resource"]) if obj.get("resource") is not None else None,
            ...
            "delivery_retry_count": obj.get("delivery_retry_count"),
            "next_attempt_after": obj.get("next_attempt_after"),
            "failure_deletion_timestamp": obj.get("failure_deletion_timestamp"),
