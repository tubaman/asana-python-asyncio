...
class TriggerRule200Response(BaseModel):
    """
    TriggerRule200Response
    """ # noqa: E501
    data: Optional[RuleTriggerResponse] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": RuleTriggerResponse.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
