...
class GetProjectMembership200Response(BaseModel):
    """
    GetProjectMembership200Response
    """ # noqa: E501
    data: Optional[ProjectMembershipNormalResponse] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": ProjectMembershipNormalResponse.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
