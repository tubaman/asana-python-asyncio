...
class GetTaskTemplate200Response(BaseModel):
    """
    GetTaskTemplate200Response
    """ # noqa: E501
    data: Optional[TaskTemplateResponse] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": TaskTemplateResponse.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
