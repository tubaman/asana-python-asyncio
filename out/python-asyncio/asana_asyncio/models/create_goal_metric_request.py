...
class CreateGoalMetricRequest(BaseModel):
    """
    CreateGoalMetricRequest
    """ # noqa: E501
    data: Optional[GoalMetricBase] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": GoalMetricBase.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
