...
class GraphExportResponse(BaseModel):
    ...
    resource_subtype: Optional[StrictStr] = Field(default=None, description="A *graph_export* object represents a request to export the data starting from a parent object")
    ...
    __properties: ClassVar[List[str]] = ["gid", "resource_type", "resource_subtype", "status", "new_graph_export"]
