...
class SectionResponse(BaseModel):
    ...
    name: Optional[StrictStr] = Field(default=None, description="The name of the section (i.e. the text displayed as the section header).")
    ...
    projects: Optional[List[ProjectCompact]] = Field(default=None, description="*Deprecated - please use project instead*")
    __properties: ClassVar[List[str]] = ["gid", "resource_type", "name", "created_at", "project", "projects"]
