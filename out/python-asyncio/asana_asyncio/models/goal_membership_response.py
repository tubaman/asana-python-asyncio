...
class GoalMembershipResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["gid", "resource_type", "resource_subtype", "member", "parent", "role", "goal", "user", "workspace"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "user": GoalMembershipResponseAllOfUser.from_dict(obj.get("user")) if obj.get("user") is not None else None,
            "workspace": GoalMembershipResponseAllOfWorkspace.from_dict(obj.get("workspace")) if obj.get("workspace") is not None else None
        })
        return _obj
