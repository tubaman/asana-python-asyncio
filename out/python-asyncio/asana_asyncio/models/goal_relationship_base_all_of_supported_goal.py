...
class GoalRelationshipBaseAllOfSupportedGoal(BaseModel):
    """
    ...
    owner: Optional[GoalCompactAllOfOwner] = None
    __properties: ClassVar[List[str]] = ["gid", "resource_type", "name", "owner"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "owner": GoalCompactAllOfOwner.from_dict(obj.get("owner")) if obj.get("owner") is not None else None
        })
        return _obj
