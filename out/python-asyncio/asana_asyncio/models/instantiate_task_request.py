...
class InstantiateTaskRequest(BaseModel):
    """
    InstantiateTaskRequest
    """ # noqa: E501
    data: Optional[TaskTemplateInstantiateTaskRequest] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": TaskTemplateInstantiateTaskRequest.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
