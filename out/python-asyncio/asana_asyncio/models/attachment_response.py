...
class AttachmentResponse(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "host": obj.get("host"),
            "parent": AttachmentResponseAllOfParent.from_dict(obj["parent"]) if obj.get("parent") is not None else None,
            "size": obj.get("size"),
