...
class AuditLogEvent(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "actor": AuditLogEventActor.from_dict(obj["actor"]) if obj.get("actor") is not None else None,
            "resource": AuditLogEventResource.from_dict(obj["resource"]) if obj.get("resource") is not None else None,
            "details": AuditLogEventDetails.from_dict(obj["details"]) if obj.get("details") is not None else None,
            "context": AuditLogEventContext.from_dict(obj["context"]) if obj.get("context") is not None else None
        })
        return _obj
