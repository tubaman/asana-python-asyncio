...
class PortfolioRequest(BaseModel):
    ...
    members: Optional[List[StrictStr]] = Field(default=None, description="An array of strings identifying users. These can either be the string \"me\", an email, or the gid of a user.")
    workspace: Optional[StrictStr] = Field(default=None, description="Gid of an object.")
    public: Optional[StrictBool] = Field(default=None, description="True if the portfolio is public to its workspace members.")
    __properties: ClassVar[List[str]] = ["gid", "resource_type", "name", "archived", "color", "members", "workspace", "public"]
