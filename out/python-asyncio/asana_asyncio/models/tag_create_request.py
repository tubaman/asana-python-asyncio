...
class TagCreateRequest(BaseModel):
    ...
    followers: Optional[List[StrictStr]] = Field(default=None, description="An array of strings identifying users. These can either be the string \"me\", an email, or the gid of a user.")
    workspace: Optional[StrictStr] = Field(default=None, description="Gid of an object.")
    __properties: ClassVar[List[str]] = ["gid", "resource_type", "name", "color", "notes", "followers", "workspace"]
