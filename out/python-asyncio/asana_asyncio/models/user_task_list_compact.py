...
class UserTaskListCompact(BaseModel):
    ...
    owner: Optional[UserTaskListCompactAllOfOwner] = None
    workspace: Optional[UserTaskListCompactAllOfWorkspace] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "owner": UserTaskListCompactAllOfOwner.from_dict(obj.get("owner")) if obj.get("owner") is not None else None,
            "workspace": UserTaskListCompactAllOfWorkspace.from_dict(obj.get("workspace")) if obj.get("workspace") is not None else None
        })
        return _obj
