...
class GetTaskTemplates200Response(BaseModel):
    """
    GetTaskTemplates200Response
    """ # noqa: E501
    data: Optional[List[TaskTemplateCompact]] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": [TaskTemplateCompact.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
