...
class GetUserTaskList200Response(BaseModel):
    """
    GetUserTaskList200Response
    """ # noqa: E501
    data: Optional[UserTaskListCompact] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": UserTaskListCompact.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
