...
class ProjectRequest(BaseModel):
    ...
    followers: Optional[StrictStr] = Field(default=None, description="*Create-only*. Comma separated string of users. Followers are a subset of members who have opted in to receive \"tasks added\" notifications for a project.")
    owner: Optional[StrictStr] = Field(default=None, description="The current owner of the project, may be null.")
    team: Optional[StrictStr] = Field(default=None, description="The team that this project is shared with.")
    workspace: Optional[StrictStr] = Field(default=None, description="The `gid` of a workspace.")
    __properties: ClassVar[List[str]] = ["gid", "resource_type", "name", "archived", "color", "created_at", "current_status", "current_status_update", "custom_field_settings", "default_view", "due_date", "due_on", "html_notes", "members", "modified_at", "notes", "public", "start_on", "default_access_level", "minimum_access_level_for_customization", "minimum_access_level_for_sharing", "custom_fields", "followers", "owner", "team", "workspace"]
