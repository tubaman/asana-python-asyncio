...
class GetPortfolioMembership200Response(BaseModel):
    """
    GetPortfolioMembership200Response
    """ # noqa: E501
    data: Optional[DeprecatedPortfolioMembershipCompact] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": DeprecatedPortfolioMembershipCompact.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
