...
class EventResponse(BaseModel):
    ...
    """ # noqa: E501
    user: Optional[UserCompact] = Field(default=None, description="The user who triggered the event.")
    resource: Optional[AsanaNamedResource] = Field(default=None, description="The resource which has triggered the event by being modified in some way.")
    ...
    parent: Optional[AsanaNamedResource] = Field(default=None, description="For added/removed events, the parent object that resource was added to or removed from. The parent will be `null` for other event types.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "parent": AsanaNamedResource.from_dict(obj["parent"]) if obj.get("parent") is not None else None,
            "created_at": obj.get("created_at"),
            "change": EventResponseChange.from_dict(obj["change"]) if obj.get("change") is not None else None
        })
        return _obj
