...
class ProjectResponse(BaseModel):
    ...
    custom_field_settings: Optional[List[CustomFieldSettingResponse]] = Field(default=None, description="Array of Custom Field Settings (in compact form).")
    ...
    public: Optional[StrictBool] = Field(default=None, description="True if the project is public to its team.")
    ...
    custom_fields: Optional[List[CustomFieldCompact]] = Field(default=None, description="Array of Custom Fields.")
    completed: Optional[StrictBool] = Field(default=None, description="True if the project is currently marked complete, false if not.")
    completed_at: Optional[datetime] = Field(default=None, description="The time at which this project was completed, or null if the project is not completed.")
    completed_by: Optional[ProjectResponseAllOfCompletedBy] = None
    followers: Optional[List[UserCompact]] = Field(default=None, description="Array of users following this project. Followers are a subset of members who have opted in to receive \"tasks added\" notifications for a project.")
    owner: Optional[ProjectResponseAllOfOwner] = None
    team: Optional[ProjectResponseAllOfTeam] = None
    icon: Optional[StrictStr] = Field(default=None, description="The icon for a project.")
    permalink_url: Optional[StrictStr] = Field(default=None, description="A url that points directly to the object within Asana.")
    project_brief: Optional[ProjectResponseAllOfProjectBrief] = None
    created_from_template: Optional[ProjectResponseAllOfCreatedFromTemplate] = None
    workspace: Optional[ProjectResponseAllOfWorkspace] = None
    ...
    def color_validate_enum(cls, value):
        ...
        if value not in ('dark-pink', 'dark-green', 'dark-blue', 'dark-red', 'dark-teal', 'dark-brown', 'dark-orange', 'dark-purple', 'dark-warm-gray', 'light-pink', 'light-green', 'light-blue', 'light-red', 'light-teal', 'light-brown', 'light-orange', 'light-purple', 'light-warm-gray', 'none', 'null'):
            raise ValueError("must be one of enum values ('dark-pink', 'dark-green', 'dark-blue', 'dark-red', 'dark-teal', 'dark-brown', 'dark-orange', 'dark-purple', 'dark-warm-gray', 'light-pink', 'light-green', 'light-blue', 'light-red', 'light-teal', 'light-brown', 'light-orange', 'light-purple', 'light-warm-gray', 'none', 'null')")
        return value
    ...
    def default_view_validate_enum(cls, value):
        ...
        if value not in ('list', 'board', 'calendar', 'timeline'):
    ...
    def icon_validate_enum(cls, value):
        ...
        if value not in ('list', 'board', 'timeline', 'calendar', 'rocket', 'people', 'graph', 'star', 'bug', 'light_bulb', 'globe', 'gear', 'notebook', 'computer', 'check', 'target', 'html', 'megaphone', 'chat_bubbles', 'briefcase', 'page_layout', 'mountain_flag', 'puzzle', 'presentation', 'line_and_symbols', 'speed_dial', 'ribbon', 'shoe', 'shopping_basket', 'map', 'ticket', 'coins'):
            raise ValueError("must be one of enum values ('list', 'board', 'timeline', 'calendar', 'rocket', 'people', 'graph', 'star', 'bug', 'light_bulb', 'globe', 'gear', 'notebook', 'computer', 'check', 'target', 'html', 'megaphone', 'chat_bubbles', 'briefcase', 'page_layout', 'mountain_flag', 'puzzle', 'presentation', 'line_and_symbols', 'speed_dial', 'ribbon', 'shoe', 'shopping_basket', 'map', 'ticket', 'coins')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        if self.custom_field_settings:
            for _item in self.custom_field_settings:
                if _item:
        ...
        # override the default output from pydantic by calling `to_dict()` of project_brief
        if self.project_brief:
            _dict['project_brief'] = self.project_brief.to_dict()
        # override the default output from pydantic by calling `to_dict()` of created_from_template
        if self.created_from_template:
            _dict['created_from_template'] = self.created_from_template.to_dict()
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "current_status": ProjectBaseAllOfCurrentStatus.from_dict(obj.get("current_status")) if obj.get("current_status") is not None else None,
            "current_status_update": ProjectBaseAllOfCurrentStatusUpdate.from_dict(obj.get("current_status_update")) if obj.get("current_status_update") is not None else None,
            "custom_field_settings": [CustomFieldSettingResponse.from_dict(_item) for _item in obj.get("custom_field_settings")] if obj.get("custom_field_settings") is not None else None,
            "default_view": obj.get("default_view"),
            "due_date": obj.get("due_date"),
            "due_on": obj.get("due_on"),
            "html_notes": obj.get("html_notes"),
            "members": [UserCompact.from_dict(_item) for _item in obj.get("members")] if obj.get("members") is not None else None,
            ...
            "completed_by": ProjectResponseAllOfCompletedBy.from_dict(obj.get("completed_by")) if obj.get("completed_by") is not None else None,
            "followers": [UserCompact.from_dict(_item) for _item in obj.get("followers")] if obj.get("followers") is not None else None,
            "owner": ProjectResponseAllOfOwner.from_dict(obj.get("owner")) if obj.get("owner") is not None else None,
            "team": ProjectResponseAllOfTeam.from_dict(obj.get("team")) if obj.get("team") is not None else None,
            "icon": obj.get("icon"),
            "permalink_url": obj.get("permalink_url"),
            "project_brief": ProjectResponseAllOfProjectBrief.from_dict(obj.get("project_brief")) if obj.get("project_brief") is not None else None,
            "created_from_template": ProjectResponseAllOfCreatedFromTemplate.from_dict(obj.get("created_from_template")) if obj.get("created_from_template") is not None else None,
            "workspace": ProjectResponseAllOfWorkspace.from_dict(obj.get("workspace")) if obj.get("workspace") is not None else None
        })
        return _obj
