...
class ProjectResponse(BaseModel):
    ...
    completed_by: Optional[UserCompact] = Field(default=None, description="The user that marked this project complete, or null if the project is not completed.")
    ...
    def color_validate_enum(cls, value):
        ...
        if value not in set(['dark-pink', 'dark-green', 'dark-blue', 'dark-red', 'dark-teal', 'dark-brown', 'dark-orange', 'dark-purple', 'dark-warm-gray', 'light-pink', 'light-green', 'light-blue', 'light-red', 'light-teal', 'light-brown', 'light-orange', 'light-purple', 'light-warm-gray', 'none']):
            raise ValueError("must be one of enum values ('dark-pink', 'dark-green', 'dark-blue', 'dark-red', 'dark-teal', 'dark-brown', 'dark-orange', 'dark-purple', 'dark-warm-gray', 'light-pink', 'light-green', 'light-blue', 'light-red', 'light-teal', 'light-brown', 'light-orange', 'light-purple', 'light-warm-gray', 'none')")
        return value
    ...
    def icon_validate_enum(cls, value):
        ...
        if value not in set(['list', 'board', 'timeline', 'calendar', 'rocket', 'people', 'graph', 'star', 'bug', 'light_bulb', 'globe', 'gear', 'notebook', 'computer', 'check', 'target', 'html', 'megaphone', 'chat_bubbles', 'briefcase', 'page_layout', 'mountain_flag', 'puzzle', 'presentation', 'line_and_symbols', 'speed_dial', 'ribbon', 'shoe', 'shopping_basket', 'map', 'ticket', 'coins']):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "owner": ProjectResponseAllOfOwner.from_dict(obj["owner"]) if obj.get("owner") is not None else None,
            "team": ProjectResponseAllOfTeam.from_dict(obj["team"]) if obj.get("team") is not None else None,
            "icon": obj.get("icon"),
            "permalink_url": obj.get("permalink_url"),
            "project_brief": ProjectResponseAllOfProjectBrief.from_dict(obj["project_brief"]) if obj.get("project_brief") is not None else None,
            "created_from_template": ProjectResponseAllOfCreatedFromTemplate.from_dict(obj["created_from_template"]) if obj.get("created_from_template") is not None else None,
            "workspace": ProjectResponseAllOfWorkspace.from_dict(obj["workspace"]) if obj.get("workspace") is not None else None
        })
        return _obj
