...
class AuditLogEventContext(BaseModel):
    ...
    on_behalf_of_user_id: Optional[StrictInt] = Field(default=None, description="The ID of the user who requested a change via support.")
    __properties: ClassVar[List[str]] = ["context_type", "api_authentication_method", "client_ip_address", "user_agent", "oauth_app_name", "rule_name", "on_behalf_of_user_id"]
