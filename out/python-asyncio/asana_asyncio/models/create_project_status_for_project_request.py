...
class CreateProjectStatusForProjectRequest(BaseModel):
    """
    CreateProjectStatusForProjectRequest
    """ # noqa: E501
    data: Optional[ProjectStatusBase] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": ProjectStatusBase.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
