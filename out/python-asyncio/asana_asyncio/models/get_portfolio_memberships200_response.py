...
class GetPortfolioMemberships200Response(BaseModel):
    """
    GetPortfolioMemberships200Response
    """ # noqa: E501
    data: Optional[List[DeprecatedPortfolioMembershipCompact]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [DeprecatedPortfolioMembershipCompact.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
