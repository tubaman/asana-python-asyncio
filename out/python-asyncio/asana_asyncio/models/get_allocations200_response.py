...
class GetAllocations200Response(BaseModel):
    """
    GetAllocations200Response
    """ # noqa: E501
    data: Optional[List[AllocationResponse]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [AllocationResponse.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
