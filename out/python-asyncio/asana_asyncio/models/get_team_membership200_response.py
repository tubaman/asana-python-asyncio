...
class GetTeamMembership200Response(BaseModel):
    """
    GetTeamMembership200Response
    """ # noqa: E501
    data: Optional[TeamMembershipCompact] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": TeamMembershipCompact.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
