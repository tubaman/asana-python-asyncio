...
class UserResponse(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "email": obj.get("email"),
            "photo": UserBaseResponseAllOfPhoto.from_dict(obj["photo"]) if obj.get("photo") is not None else None,
            "workspaces": [WorkspaceCompact.from_dict(_item) for _item in obj["workspaces"]] if obj.get("workspaces") is not None else None
        })
        return _obj
