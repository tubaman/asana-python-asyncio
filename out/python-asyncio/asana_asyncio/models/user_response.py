...
class UserResponse(BaseModel):
    ...
    workspaces: Optional[List[WorkspaceCompact]] = Field(default=None, description="Workspaces and organizations this user may access. Note\\: The API will only return workspaces and organizations that also contain the authenticated user.")
    __properties: ClassVar[List[str]] = ["gid", "resource_type", "name", "email", "photo", "workspaces"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "workspaces": [WorkspaceCompact.from_dict(_item) for _item in obj.get("workspaces")] if obj.get("workspaces") is not None else None
        })
        return _obj
