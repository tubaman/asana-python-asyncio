...
class ProjectTemplateInstantiateProjectRequest(BaseModel):
    ...
    public: Optional[StrictBool] = Field(default=None, description="Sets the project to public to its team.")
    ...
    requested_dates: Optional[List[DateVariableRequest]] = Field(default=None, description="Array of mappings of date variables to calendar dates.")
    ...
    __properties: ClassVar[List[str]] = ["name", "team", "public", "is_strict", "requested_dates", "requested_roles"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.requested_dates:
            for _item in self.requested_dates:
                if _item:
        ...
        if self.requested_roles:
            for _item in self.requested_roles:
                if _item:
                    _items.append(_item.to_dict())
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "requested_dates": [DateVariableRequest.from_dict(_item) for _item in obj.get("requested_dates")] if obj.get("requested_dates") is not None else None,
            "requested_roles": [RequestedRoleRequest.from_dict(_item) for _item in obj.get("requested_roles")] if obj.get("requested_roles") is not None else None
        })
        return _obj
