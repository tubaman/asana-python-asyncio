...
class ProjectSaveAsTemplateRequest(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": ProjectSaveAsTemplateRequest.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj

# TODO: Rewrite to not use raise_errors
ProjectSaveAsTemplateRequest.model_rebuild(raise_errors=False)
