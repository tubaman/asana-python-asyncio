...
class ProjectBriefResponse(BaseModel):
    ...
    title: Optional[StrictStr] = Field(default=None, description="The title of the project brief.")
    html_text: Optional[StrictStr] = Field(default=None, description="HTML formatted text for the project brief.")
    text: Optional[StrictStr] = Field(default=None, description="[Opt In](/docs/inputoutput-options). The plain text of the project brief.")
    permalink_url: Optional[StrictStr] = Field(default=None, description="A url that points directly to the object within Asana.")
    project: Optional[ProjectBriefResponseAllOfProject] = None
    __properties: ClassVar[List[str]] = ["gid", "resource_type", "title", "html_text", "text", "permalink_url", "project"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "project": ProjectBriefResponseAllOfProject.from_dict(obj.get("project")) if obj.get("project") is not None else None
        })
        return _obj
