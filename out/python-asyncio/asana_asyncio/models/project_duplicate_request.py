...
class ProjectDuplicateRequest(BaseModel):
    ...
    include: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="A comma-separated list of elements that will be duplicated to the new project. Tasks are always included. ##### Fields - forms - members - notes - task_assignee - task_attachments - task_dates - task_dependencies - task_followers - task_notes - task_projects - task_subtasks - task_tags")
    ...
    def include_validate_regular_expression(cls, value):
        ...
        if not re.match(r"([members|notes|forms|task_notes|task_assignee|task_subtasks|task_attachments|task_dates|task_dependencies|task_followers|task_tags|task_projects])(,\1)*", value):
            raise ValueError(r"must validate the regular expression /([members|notes|forms|task_notes|task_assignee|task_subtasks|task_attachments|task_dates|task_dependencies|task_followers|task_tags|task_projects])(,\1)*/")
        return value
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "schedule_dates": ProjectDuplicateRequestScheduleDates.from_dict(obj.get("schedule_dates")) if obj.get("schedule_dates") is not None else None
        })
        return _obj
