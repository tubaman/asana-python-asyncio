...
class CustomFieldSettingResponse(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "project": CustomFieldSettingResponseAllOfProject.from_dict(obj["project"]) if obj.get("project") is not None else None,
            "is_important": obj.get("is_important"),
            "parent": CustomFieldSettingResponseAllOfParent.from_dict(obj["parent"]) if obj.get("parent") is not None else None,
            "custom_field": CustomFieldSettingResponseAllOfCustomField.from_dict(obj["custom_field"]) if obj.get("custom_field") is not None else None
        })
        return _obj
