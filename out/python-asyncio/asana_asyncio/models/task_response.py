...
class TaskResponse(BaseModel):
    ...
    assignee: Optional[TaskResponseAllOfAssignee] = None
    assignee_section: Optional[TaskResponseAllOfAssigneeSection] = None
    custom_fields: Optional[List[CustomFieldResponse]] = Field(default=None, description="Array of custom field values applied to the task. These represent the custom field values recorded on this project for a particular custom field. For example, these custom field values will contain an `enum_value` property for custom fields of type `enum`, a `text_value` property for custom fields of type `text`, and so on. Please note that the `gid` returned on each custom field value *is identical* to the `gid` of the custom field, which allows referencing the custom field metadata through the `/custom_fields/custom_field-gid` endpoint.")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "assignee": TaskResponseAllOfAssignee.from_dict(obj.get("assignee")) if obj.get("assignee") is not None else None,
            "assignee_section": TaskResponseAllOfAssigneeSection.from_dict(obj.get("assignee_section")) if obj.get("assignee_section") is not None else None,
            "custom_fields": [CustomFieldResponse.from_dict(_item) for _item in obj.get("custom_fields")] if obj.get("custom_fields") is not None else None,
            "followers": [UserCompact.from_dict(_item) for _item in obj.get("followers")] if obj.get("followers") is not None else None,
            "parent": TaskResponseAllOfParent.from_dict(obj.get("parent")) if obj.get("parent") is not None else None,
            "projects": [ProjectCompact.from_dict(_item) for _item in obj.get("projects")] if obj.get("projects") is not None else None,
            "tags": [TagCompact.from_dict(_item) for _item in obj.get("tags")] if obj.get("tags") is not None else None,
            "workspace": TaskResponseAllOfWorkspace.from_dict(obj.get("workspace")) if obj.get("workspace") is not None else None,
