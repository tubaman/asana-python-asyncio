...
class GoalResponseAllOfMetric(BaseModel):
    """
    ...
    can_manage: Optional[StrictBool] = Field(default=None, description="*Conditional*. Only relevant for `progress_source` of type `external`. This boolean indicates whether the requester has the ability to update the current value of this metric. This returns `true` if the external metric was created by the requester, `false` otherwise.")
    __properties: ClassVar[List[str]] = ["gid", "resource_type", "resource_subtype", "precision", "unit", "currency_code", "initial_number_value", "target_number_value", "current_number_value", "current_display_value", "progress_source", "is_custom_weight", "can_manage"]
