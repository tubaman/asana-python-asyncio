...
class GoalResponseAllOfMetric(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["gid", "resource_type", "resource_subtype", "precision", "unit", "currency_code", "initial_number_value", "target_number_value", "current_number_value", "current_display_value", "progress_source", "can_manage"]
