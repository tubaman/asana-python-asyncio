...
class CreateTagForWorkspaceRequest(BaseModel):
    """
    CreateTagForWorkspaceRequest
    """ # noqa: E501
    data: Optional[TagCreateTagForWorkspaceRequest] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": TagCreateTagForWorkspaceRequest.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
