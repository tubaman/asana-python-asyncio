...
class GetMembership200Response(BaseModel):
    """
    GetMembership200Response
    """ # noqa: E501
    data: Optional[ProjectMembershipCompactResponse] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": ProjectMembershipCompactResponse.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
