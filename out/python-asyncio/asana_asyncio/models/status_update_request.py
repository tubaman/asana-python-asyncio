...
class StatusUpdateRequest(BaseModel):
    ...
    parent: StrictStr = Field(description="The id of parent to send this status update to. This can be a project, goal or portfolio.")
    __properties: ClassVar[List[str]] = ["gid", "resource_type", "title", "resource_subtype", "text", "html_text", "status_type", "parent"]
