...
class AllocationRequest(BaseModel):
    ...
    assignee: Optional[StrictStr] = Field(default=None, description="Globally unique identifier for the user or placeholder assigned to the allocation.")
    parent: Optional[StrictStr] = Field(default=None, description="Globally unique identifier for the project the allocation is on.")
