...
class GoalMetricCurrentValueRequest(BaseModel):
    ...
    current_number_value: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="*Conditional*. This number is the current value of a goal metric of type number.")
    __properties: ClassVar[List[str]] = ["gid", "resource_type", "current_number_value"]
