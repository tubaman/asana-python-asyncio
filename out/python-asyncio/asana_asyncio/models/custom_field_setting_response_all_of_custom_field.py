...
class CustomFieldSettingResponseAllOfCustomField(BaseModel):
    ...
    created_by: Optional[CustomFieldResponseAllOfCreatedBy] = None
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        if self.people_value:
            for _item in self.people_value:
                if _item:
                    _items.append(_item.to_dict())
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "created_by": CustomFieldResponseAllOfCreatedBy.from_dict(obj.get("created_by")) if obj.get("created_by") is not None else None,
            "people_value": [UserCompact.from_dict(_item) for _item in obj.get("people_value")] if obj.get("people_value") is not None else None
        })
        return _obj
