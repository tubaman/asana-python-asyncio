...
class GetTimePeriod200Response(BaseModel):
    """
    GetTimePeriod200Response
    """ # noqa: E501
    data: Optional[TimePeriodBase] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": TimePeriodBase.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
