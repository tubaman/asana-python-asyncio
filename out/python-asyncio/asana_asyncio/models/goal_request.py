...
class GoalRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["gid", "resource_type", "name", "html_notes", "notes", "due_on", "start_on", "is_workspace_level", "liked", "team", "workspace", "time_period", "owner", "followers"]
