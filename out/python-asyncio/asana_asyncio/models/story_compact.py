...
class StoryCompact(BaseModel):
    ...
    text: Optional[StrictStr] = Field(default=None, description="*Create-only*. Human-readable text for the story or comment. This will not include the name of the creator. *Note: This is not guaranteed to be stable for a given type of story. For example, text for a reassignment may not always say “assigned to …” as the text for a story can both be edited and change based on the language settings of the user making the request.* Use the `resource_subtype` property to discover the action that created the story.")
    __properties: ClassVar[List[str]] = ["gid", "resource_type", "created_at", "created_by", "resource_subtype", "text"]
