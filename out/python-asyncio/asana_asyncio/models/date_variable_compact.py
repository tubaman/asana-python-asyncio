...
class DateVariableCompact(BaseModel):
    ...
    name: Optional[StrictStr] = Field(default=None, description="The name of the date variable.")
    description: Optional[StrictStr] = Field(default=None, description="The description of what the date variable is used for when instantiating a project.")
    __properties: ClassVar[List[str]] = ["gid", "name", "description"]
