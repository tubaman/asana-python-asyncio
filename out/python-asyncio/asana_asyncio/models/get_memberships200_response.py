...
class GetMemberships200Response(BaseModel):
    """
    GetMemberships200Response
    """ # noqa: E501
    data: Optional[List[MembershipCompact]] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": [MembershipCompact.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None,
