...
class TeamRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["gid", "resource_type", "name", "description", "html_description", "organization", "visibility", "edit_team_name_or_description_access_level", "edit_team_visibility_or_trash_team_access_level", "member_invite_management_access_level", "guest_invite_management_access_level", "join_request_management_access_level", "team_member_removal_access_level"]
