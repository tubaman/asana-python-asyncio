...
class TeamRequest(BaseModel):
    ...
    html_description: Optional[StrictStr] = Field(default=None, description="The description of the team with formatting as HTML. ")
    organization: Optional[StrictStr] = Field(default=None, description="The organization/workspace the team belongs to. This must be the same organization you are in and cannot be changed once set. ")
    ...
    join_request_management_access_level: Optional[StrictStr] = Field(default=None, description="Controls who can accept or deny join team requests for a Membership by Request team. This field can only be updated when the team's `visibility` field is `request_to_join`. ")
    team_member_removal_access_level: Optional[StrictStr] = Field(default=None, description="Controls who can remove team members ")
    team_content_management_access_level: Optional[StrictStr] = Field(default=None, description="Controls who can create and share content with the team ")
    endorsed: Optional[StrictBool] = Field(default=None, description="Whether the team has been endorsed ")
    __properties: ClassVar[List[str]] = ["gid", "resource_type", "name", "description", "html_description", "organization", "visibility", "edit_team_name_or_description_access_level", "edit_team_visibility_or_trash_team_access_level", "member_invite_management_access_level", "guest_invite_management_access_level", "join_request_management_access_level", "team_member_removal_access_level", "team_content_management_access_level", "endorsed"]
    ...
    def visibility_validate_enum(cls, value):
        ...
        if value not in set(['secret', 'request_to_join', 'public']):
    ...
    def edit_team_name_or_description_access_level_validate_enum(cls, value):
        ...
        if value not in set(['all_team_members', 'only_team_admins']):
    ...
    @field_validator('team_content_management_access_level')
    def team_content_management_access_level_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value

        if value not in set(['no_restriction', 'only_team_admins']):
            raise ValueError("must be one of enum values ('no_restriction', 'only_team_admins')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "team_content_management_access_level": obj.get("team_content_management_access_level"),
