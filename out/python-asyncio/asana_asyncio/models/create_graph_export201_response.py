...
class CreateGraphExport201Response(BaseModel):
    """
    CreateGraphExport201Response
    """ # noqa: E501
    data: Optional[GraphExportResponse] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": GraphExportResponse.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
