...
class GetCustomType200Response(BaseModel):
    """
    GetCustomType200Response
    """ # noqa: E501
    data: Optional[CustomTypeResponse] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": CustomTypeResponse.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
