...
class CustomTypeResponse(BaseModel):
    ...
    name: Optional[StrictStr] = Field(default=None, description="The name of the custom type.")
    status_options: Optional[List[CustomTypeStatusOptionResponse]] = Field(default=None, description="The available options for the custom type.")
    __properties: ClassVar[List[str]] = ["gid", "resource_type", "name", "status_options"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        if self.status_options:
            ...
            _dict['status_options'] = _items
        # set to None if status_options (nullable) is None
        # and model_fields_set contains the field
        if self.status_options is None and "status_options" in self.model_fields_set:
            _dict['status_options'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "status_options": [CustomTypeStatusOptionResponse.from_dict(_item) for _item in obj["status_options"]] if obj.get("status_options") is not None else None
        })
        return _obj
