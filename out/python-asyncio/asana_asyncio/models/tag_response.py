...
class TagResponse(BaseModel):
    ...
    followers: Optional[List[UserCompact]] = Field(default=None, description="<p><strong style=\"color: #4573D2\">Full object requires scope: </strong><code>users:read</code></p>  Array of users following this tag.")
