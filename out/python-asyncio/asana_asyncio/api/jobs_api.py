...
class JobsApi:
    ...
    async def get_job(
        self,
        job_gid: Annotated[StrictStr, Field(description="Globally unique identifier for the job.")],
        ...
        :param job_gid: Globally unique identifier for the job. (required)
        :type job_gid: str
