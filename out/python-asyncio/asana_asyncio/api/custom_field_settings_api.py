...
class CustomFieldSettingsApi:
    ...
    async def get_custom_field_settings_for_portfolio(
        ...
        _param = self._get_custom_field_settings_for_portfolio_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetCustomFieldSettingsForProject200Response",
            '400': "ErrorResponse",
            '401': "ErrorResponse",
            '403': "ErrorResponse",
            '404': "ErrorResponse",
    ...
    @validate_call
    async def get_custom_field_settings_for_portfolio_with_http_info(
        self,
        portfolio_gid: Annotated[StrictStr, Field(description="Globally unique identifier for the portfolio.")],
        opt_pretty: Annotated[Optional[StrictBool], Field(description="Provides “pretty” output. Provides the response in a “pretty” format. In the case of JSON this means doing proper line breaking and indentation to make it readable. This will take extra time and increase the response size so it is advisable only to use this during debugging.")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=100, strict=True, ge=1)]], Field(description="Results per page. The number of objects to return per page. The value must be between 1 and 100.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetCustomFieldSettingsForProject200Response]:
        """Get a portfolio's custom fields
    ...
    @validate_call
    async def get_custom_field_settings_for_portfolio_without_preload_content(
        self,
        portfolio_gid: Annotated[StrictStr, Field(description="Globally unique identifier for the portfolio.")],
        opt_pretty: Annotated[Optional[StrictBool], Field(description="Provides “pretty” output. Provides the response in a “pretty” format. In the case of JSON this means doing proper line breaking and indentation to make it readable. This will take extra time and increase the response size so it is advisable only to use this during debugging.")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=100, strict=True, ge=1)]], Field(description="Results per page. The number of objects to return per page. The value must be between 1 and 100.")] = None,
    ...
    def _get_custom_field_settings_for_portfolio_serialize(
        self,
        portfolio_gid,
        opt_pretty,
        limit,
    ...
    async def get_custom_field_settings_for_project(
        ...
        _param = self._get_custom_field_settings_for_project_serialize(
    ...
    @validate_call
    async def get_custom_field_settings_for_project_with_http_info(
        self,
        project_gid: Annotated[StrictStr, Field(description="Globally unique identifier for the project.")],
        opt_pretty: Annotated[Optional[StrictBool], Field(description="Provides “pretty” output. Provides the response in a “pretty” format. In the case of JSON this means doing proper line breaking and indentation to make it readable. This will take extra time and increase the response size so it is advisable only to use this during debugging.")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=100, strict=True, ge=1)]], Field(description="Results per page. The number of objects to return per page. The value must be between 1 and 100.")] = None,
    ...
    @validate_call
    async def get_custom_field_settings_for_project_without_preload_content(
        self,
        project_gid: Annotated[StrictStr, Field(description="Globally unique identifier for the project.")],
        opt_pretty: Annotated[Optional[StrictBool], Field(description="Provides “pretty” output. Provides the response in a “pretty” format. In the case of JSON this means doing proper line breaking and indentation to make it readable. This will take extra time and increase the response size so it is advisable only to use this during debugging.")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=100, strict=True, ge=1)]], Field(description="Results per page. The number of objects to return per page. The value must be between 1 and 100.")] = None,
    ...
    def _get_custom_field_settings_for_project_serialize(
        self,
        project_gid,
        opt_pretty,
        limit,
