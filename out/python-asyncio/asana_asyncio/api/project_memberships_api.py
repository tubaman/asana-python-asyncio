...
class ProjectMembershipsApi:
    ...
    async def get_project_membership(
        self,
        project_membership_gid: StrictStr,
        ...
        :param project_membership_gid: (required)
        ...
        _param = self._get_project_membership_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetProjectMembership200Response",
            '400': "ErrorResponse",
            '401': "ErrorResponse",
            '403': "ErrorResponse",
            '404': "ErrorResponse",
    ...
    @validate_call
    async def get_project_membership_with_http_info(
        self,
        project_membership_gid: StrictStr,
        opt_pretty: Annotated[Optional[StrictBool], Field(description="Provides “pretty” output. Provides the response in a “pretty” format. In the case of JSON this means doing proper line breaking and indentation to make it readable. This will take extra time and increase the response size so it is advisable only to use this during debugging.")] = None,
        opt_fields: Annotated[Optional[List[StrictStr]], Field(description="This endpoint returns a resource which excludes some properties by default. To include those optional properties, set this query parameter to a comma-separated list of the properties you wish to include.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetProjectMembership200Response]:
        """Get a project membership
    ...
    @validate_call
    async def get_project_membership_without_preload_content(
        self,
        project_membership_gid: StrictStr,
        opt_pretty: Annotated[Optional[StrictBool], Field(description="Provides “pretty” output. Provides the response in a “pretty” format. In the case of JSON this means doing proper line breaking and indentation to make it readable. This will take extra time and increase the response size so it is advisable only to use this during debugging.")] = None,
        opt_fields: Annotated[Optional[List[StrictStr]], Field(description="This endpoint returns a resource which excludes some properties by default. To include those optional properties, set this query parameter to a comma-separated list of the properties you wish to include.")] = None,
    ...
    def _get_project_membership_serialize(
        self,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/project_memberships/{project_membership_gid}',
    ...
    @validate_call
    async def get_project_memberships_for_project(
        self,
        ...
        _param = self._get_project_memberships_for_project_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetProjectMembershipsForProject200Response",
            '400': "ErrorResponse",
            '401': "ErrorResponse",
            '403': "ErrorResponse",
            '404': "ErrorResponse",
    ...
    @validate_call
    async def get_project_memberships_for_project_with_http_info(
        self,
        project_gid: Annotated[StrictStr, Field(description="Globally unique identifier for the project.")],
        user: Annotated[Optional[StrictStr], Field(description="A string identifying a user. This can either be the string \"me\", an email, or the gid of a user.")] = None,
        opt_pretty: Annotated[Optional[StrictBool], Field(description="Provides “pretty” output. Provides the response in a “pretty” format. In the case of JSON this means doing proper line breaking and indentation to make it readable. This will take extra time and increase the response size so it is advisable only to use this during debugging.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetProjectMembershipsForProject200Response]:
        """Get memberships from a project
    ...
    @validate_call
    async def get_project_memberships_for_project_without_preload_content(
        self,
        project_gid: Annotated[StrictStr, Field(description="Globally unique identifier for the project.")],
        user: Annotated[Optional[StrictStr], Field(description="A string identifying a user. This can either be the string \"me\", an email, or the gid of a user.")] = None,
        opt_pretty: Annotated[Optional[StrictBool], Field(description="Provides “pretty” output. Provides the response in a “pretty” format. In the case of JSON this means doing proper line breaking and indentation to make it readable. This will take extra time and increase the response size so it is advisable only to use this during debugging.")] = None,
    ...
    def _get_project_memberships_for_project_serialize(
        self,
        project_gid,
        user,
        opt_pretty,
