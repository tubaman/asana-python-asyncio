...
class MembershipsApi:
    ...
    async def get_membership(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "CreateMembership201Response",
            '400': "ErrorResponse",
            '401': "ErrorResponse",
            '403': "ErrorResponse",
            '404': "ErrorResponse",
    ...
    async def get_memberships(
        self,
        opt_pretty: Annotated[Optional[StrictBool], Field(description="Provides “pretty” output. Provides the response in a “pretty” format. In the case of JSON this means doing proper line breaking and indentation to make it readable. This will take extra time and increase the response size so it is advisable only to use this during debugging.")] = None,
        parent: Annotated[Optional[StrictStr], Field(description="Globally unique identifier for `goal`, `project`, `portfolio`, or `custom_field`.")] = None,
        ...
        :param opt_pretty: Provides “pretty” output. Provides the response in a “pretty” format. In the case of JSON this means doing proper line breaking and indentation to make it readable. This will take extra time and increase the response size so it is advisable only to use this during debugging.
        :type opt_pretty: bool
        :param parent: Globally unique identifier for `goal`, `project`, `portfolio`, or `custom_field`.
        :type parent: str
    ...
    async def update_membership(
        self,
        membership_gid: Annotated[StrictStr, Field(description="Globally unique identifier for the membership.")],
        update_membership_request: Annotated[UpdateMembershipRequest, Field(description="The membership to update.")],
        opt_pretty: Annotated[Optional[StrictBool], Field(description="Provides “pretty” output. Provides the response in a “pretty” format. In the case of JSON this means doing proper line breaking and indentation to make it readable. This will take extra time and increase the response size so it is advisable only to use this during debugging.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        :param membership_gid: Globally unique identifier for the membership. (required)
        :type membership_gid: str
        :param update_membership_request: The membership to update. (required)
    ...
    @validate_call
    async def update_membership_with_http_info(
        self,
        membership_gid: Annotated[StrictStr, Field(description="Globally unique identifier for the membership.")],
        update_membership_request: Annotated[UpdateMembershipRequest, Field(description="The membership to update.")],
        opt_pretty: Annotated[Optional[StrictBool], Field(description="Provides “pretty” output. Provides the response in a “pretty” format. In the case of JSON this means doing proper line breaking and indentation to make it readable. This will take extra time and increase the response size so it is advisable only to use this during debugging.")] = None,
    ...
    @validate_call
    async def update_membership_without_preload_content(
        self,
        membership_gid: Annotated[StrictStr, Field(description="Globally unique identifier for the membership.")],
        update_membership_request: Annotated[UpdateMembershipRequest, Field(description="The membership to update.")],
        opt_pretty: Annotated[Optional[StrictBool], Field(description="Provides “pretty” output. Provides the response in a “pretty” format. In the case of JSON this means doing proper line breaking and indentation to make it readable. This will take extra time and increase the response size so it is advisable only to use this during debugging.")] = None,
