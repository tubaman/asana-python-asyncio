...
class CustomTypesApi:
    ...
    async def get_custom_type(
        self,
        custom_type_gid: Annotated[StrictStr, Field(description="Globally unique identifier for the custom type.")],
        ...
        :param custom_type_gid: Globally unique identifier for the custom type. (required)
        :type custom_type_gid: str
        ...
        _param = self._get_custom_type_serialize(
    ...
    @validate_call
    async def get_custom_type_with_http_info(
        self,
        custom_type_gid: Annotated[StrictStr, Field(description="Globally unique identifier for the custom type.")],
        opt_pretty: Annotated[Optional[StrictBool], Field(description="Provides “pretty” output. Provides the response in a “pretty” format. In the case of JSON this means doing proper line breaking and indentation to make it readable. This will take extra time and increase the response size so it is advisable only to use this during debugging.")] = None,
        opt_fields: Annotated[Optional[List[StrictStr]], Field(description="This endpoint returns a resource which excludes some properties by default. To include those optional properties, set this query parameter to a comma-separated list of the properties you wish to include.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetCustomType200Response]:
        """Get a custom type
    ...
    @validate_call
    async def get_custom_type_without_preload_content(
        self,
        custom_type_gid: Annotated[StrictStr, Field(description="Globally unique identifier for the custom type.")],
        opt_pretty: Annotated[Optional[StrictBool], Field(description="Provides “pretty” output. Provides the response in a “pretty” format. In the case of JSON this means doing proper line breaking and indentation to make it readable. This will take extra time and increase the response size so it is advisable only to use this during debugging.")] = None,
        opt_fields: Annotated[Optional[List[StrictStr]], Field(description="This endpoint returns a resource which excludes some properties by default. To include those optional properties, set this query parameter to a comma-separated list of the properties you wish to include.")] = None,
    ...
    def _get_custom_type_serialize(
        self,
        custom_type_gid,
        opt_pretty,
        opt_fields,
        ...
        if custom_type_gid is not None:
            _path_params['custom_type_gid'] = custom_type_gid
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/custom_types/{custom_type_gid}',
    ...
    async def get_custom_types(
        self,
        project: Annotated[StrictStr, Field(description="Globally unique identifier for the project, which is used as a filter when retrieving all custom types.")],
        opt_pretty: Annotated[Optional[StrictBool], Field(description="Provides “pretty” output. Provides the response in a “pretty” format. In the case of JSON this means doing proper line breaking and indentation to make it readable. This will take extra time and increase the response size so it is advisable only to use this during debugging.")] = None,
        ...
        _param = self._get_custom_types_serialize(
            project=project,
            opt_pretty=opt_pretty,
            limit=limit,
            offset=offset,
    ...
    @validate_call
    async def get_custom_types_with_http_info(
        self,
        project: Annotated[StrictStr, Field(description="Globally unique identifier for the project, which is used as a filter when retrieving all custom types.")],
        opt_pretty: Annotated[Optional[StrictBool], Field(description="Provides “pretty” output. Provides the response in a “pretty” format. In the case of JSON this means doing proper line breaking and indentation to make it readable. This will take extra time and increase the response size so it is advisable only to use this during debugging.")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=100, strict=True, ge=1)]], Field(description="Results per page. The number of objects to return per page. The value must be between 1 and 100.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetCustomTypes200Response]:
        """Get all custom types associated with an object
    ...
    @validate_call
    async def get_custom_types_without_preload_content(
        self,
        project: Annotated[StrictStr, Field(description="Globally unique identifier for the project, which is used as a filter when retrieving all custom types.")],
        opt_pretty: Annotated[Optional[StrictBool], Field(description="Provides “pretty” output. Provides the response in a “pretty” format. In the case of JSON this means doing proper line breaking and indentation to make it readable. This will take extra time and increase the response size so it is advisable only to use this during debugging.")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=100, strict=True, ge=1)]], Field(description="Results per page. The number of objects to return per page. The value must be between 1 and 100.")] = None,
    ...
    def _get_custom_types_serialize(
        self,
        project,
        opt_pretty,
        limit,
