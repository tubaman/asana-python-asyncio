...
class AttachmentsApi:
    ...
    async def create_attachment_for_object(
        ...
        file: Annotated[Optional[Union[StrictBytes, StrictStr]], Field(description="Required for `asana` attachments. ")] = None,
        ...
        connect_to_app: Annotated[Optional[StrictBool], Field(description="*Optional*. Only relevant for external attachments with a parent task. A boolean indicating whether the current app should be connected with the attachment for the purposes of showing an app components widget. Requires the app to have been added to a project the parent task is in. ")] = None,
