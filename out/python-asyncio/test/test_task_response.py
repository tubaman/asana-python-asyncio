    ...
    def make_instance(self, include_optional) -> TaskResponse:
        ...
        if include_optional:
            return TaskResponse(
                ...
                custom_type = asana_asyncio.models.custom_type_compact.CustomTypeCompact(
                    gid = '12345', 
                    resource_type = 'custom_type', 
                    name = 'Bug ticket', ),
                custom_type_status_option = asana_asyncio.models.custom_type_status_option_compact.CustomTypeStatusOptionCompact(
                    gid = '12345', 
