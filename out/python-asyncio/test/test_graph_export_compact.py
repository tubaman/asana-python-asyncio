...
class TestGraphExportCompact(unittest.TestCase):
    """GraphExportCompact unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GraphExportCompact:
        """Test GraphExportCompact
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GraphExportCompact`
        """
        model = GraphExportCompact()
        if include_optional:
            return GraphExportCompact(
                gid = '12345',
    ...
    def testGraphExportCompact(self):
        """Test GraphExportCompact"""
