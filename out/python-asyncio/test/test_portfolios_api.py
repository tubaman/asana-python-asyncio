...
class TestPortfoliosApi(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_add_custom_field_setting_for_portfolio(self) -> None:
    ...
    async def test_add_item_for_portfolio(self) -> None:
    ...
    async def test_add_members_for_portfolio(self) -> None:
    ...
    async def test_delete_portfolio(self) -> None:
    ...
    async def test_get_items_for_portfolio(self) -> None:
    ...
    async def test_remove_custom_field_setting_for_portfolio(self) -> None:
    ...
    async def test_remove_item_for_portfolio(self) -> None:
    ...
    async def test_remove_members_for_portfolio(self) -> None:
    ...
    async def test_update_portfolio(self) -> None:
