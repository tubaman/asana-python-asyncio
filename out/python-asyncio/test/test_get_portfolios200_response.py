...
class TestGetPortfolios200Response(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetPortfolios200Response:
        """Test GetPortfolios200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetPortfolios200Response`
        """
        model = GetPortfolios200Response()
        if include_optional:
            return GetPortfolios200Response(
                data = [
                    asana_asyncio.models.portfolio_compact.PortfolioCompact(
                        gid = '12345', 
