...
class TestGetTeamsForWorkspace200Response(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetTeamsForWorkspace200Response:
        """Test GetTeamsForWorkspace200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetTeamsForWorkspace200Response`
        """
        model = GetTeamsForWorkspace200Response()
        if include_optional:
            return GetTeamsForWorkspace200Response(
                data = [
                    asana_asyncio.models.team_compact.TeamCompact(
                        gid = '12345', 
                        resource_type = 'team', 
                        name = 'Marketing', )
                    ],
