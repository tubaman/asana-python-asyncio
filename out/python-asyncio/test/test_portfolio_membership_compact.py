...
class TestPortfolioMembershipCompact(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PortfolioMembershipCompact:
        """Test PortfolioMembershipCompact
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PortfolioMembershipCompact`
        """
        model = PortfolioMembershipCompact()
        if include_optional:
