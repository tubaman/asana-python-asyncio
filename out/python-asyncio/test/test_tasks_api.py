...
class TestTasksApi(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_add_dependencies_for_task(self) -> None:
    ...
    async def test_add_dependents_for_task(self) -> None:
    ...
    async def test_add_followers_for_task(self) -> None:
    ...
    async def test_add_project_for_task(self) -> None:
    ...
    async def test_add_tag_for_task(self) -> None:
    ...
    async def test_create_subtask_for_task(self) -> None:
    ...
    async def test_duplicate_task(self) -> None:
    ...
    async def test_get_dependencies_for_task(self) -> None:
    ...
    async def test_get_dependents_for_task(self) -> None:
    ...
    async def test_get_subtasks_for_task(self) -> None:
    ...
    async def test_get_task_for_custom_id(self) -> None:
        """Test case for get_task_for_custom_id
    ...
    async def test_get_tasks_for_project(self) -> None:
    ...
    async def test_get_tasks_for_section(self) -> None:
    ...
    async def test_get_tasks_for_tag(self) -> None:
    ...
    async def test_get_tasks_for_user_task_list(self) -> None:
    ...
    async def test_remove_dependencies_for_task(self) -> None:
    ...
    async def test_remove_dependents_for_task(self) -> None:
    ...
    async def test_remove_follower_for_task(self) -> None:
    ...
    async def test_remove_project_for_task(self) -> None:
    ...
    async def test_remove_tag_for_task(self) -> None:
    ...
    async def test_search_tasks_for_workspace(self) -> None:
    ...
    async def test_set_parent_for_task(self) -> None:
