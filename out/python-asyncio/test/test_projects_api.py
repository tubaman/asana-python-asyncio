...
class TestProjectsApi(unittest.TestCase):
    ...
    def test_add_custom_field_setting_for_project(self) -> None:
    ...
    def test_add_followers_for_project(self) -> None:
    ...
    def test_add_members_for_project(self) -> None:
    ...
    def test_create_project_for_team(self) -> None:
    ...
    def test_create_project_for_workspace(self) -> None:
    ...
    def test_get_projects_for_task(self) -> None:
    ...
    def test_get_projects_for_team(self) -> None:
    ...
    def test_get_projects_for_workspace(self) -> None:
    ...
    def test_get_task_counts_for_project(self) -> None:
    ...
    def test_project_save_as_template(self) -> None:
    ...
    def test_remove_custom_field_setting_for_project(self) -> None:
    ...
    def test_remove_followers_for_project(self) -> None:
    ...
    def test_remove_members_for_project(self) -> None:
